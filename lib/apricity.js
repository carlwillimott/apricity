	        ...
	        **/
	        ...
	        value: function _defineMasterRule() {
	            ...
	            this._rules.forEach(function (rule) {
	                ...
	                master.hour = _this._calculateHour(master.hour, rule.hour);
	                master.day = _this._calculateDay(master.day, rule.day);
	                master.month = _this._calculateMonth(master.month, rule.month);
	                master.week = _this._calculateWeek(master.week, rule.week);
	            });
